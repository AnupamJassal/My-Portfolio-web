    ...
    <>
      <div className="continer project" id="projects">
        ...
        <p className="pb-3 text-center">
          These are my few projects based on my skillset... more are coming very soon !! Have a Look !
        </p>
        {/* card design */}
          ...
          <Spin>
            <div className="col-md-4">
              <div className="card rounded">
                ...
                <div className="card-body text-center">
                  ...
                  <a
                    className="ad-btn"
                    href="https://anupamjassal.github.io/anupamport.github.io/"
                  >
                    View
                  </a>
                </div>
            ...
            <div className="col-md-4">
              <div className="card rounded">
                ...
                <div className="card-image-overly m-auto mt-3">
                  <span className="card-detail-badge">Weather app (React)</span>

                  {/* <span className="card-detail-badge">IOS / ANDROID</span> */}
                </div>
                <div className="card-body text-center">
                  <div className="ad-title m-auto">
                    <h5 className="text-uppercase">Weather Check</h5>
                  </div>
                  <a
                    className="ad-btn"
                    href="put my github_link"
                  >
                    View
                  </a>
                </div>
            ...
            <div className="col-md-4">
              <div className="card rounded">
                <div className="card-image">
                  ...
                  <img
                    src="https://hawkticehurst.com/imgs/hero.png"
                    alt="project1"
                  />
                </div>
                <div className="card-image-overly m-auto mt-3">
